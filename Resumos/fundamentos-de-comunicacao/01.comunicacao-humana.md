...
1. ## **Conceitos de Comunicação**
    ...
    - ### **Tipos de comunicação**
        ...
        - #### Direta ou indireta:
            ...
            - **Indireta**
                Quando há um intermediário entre o emissor e o receptor, por exemplo, carta, livro, telefone, etc.
    ...
    - ### **Componentes da Comunicação**
        ...
        Os componentes podem variar depende da abordagem e do leitor em questão, mas se considerarmos um modelo canônico, os componentes são:
    ...
    - ### **As máximas comunicacionais de Grice**
        ...
        De acordo com Grice, para haver uma comunicação eficiente, deve existir uma cooperação entre os participantes da interação, para isso Grice descreveu as Máximas, que servem como princípios para garantir uma comunicação eficiente.
...
2. ## **Relação de comunicação, linguagem e língua**
